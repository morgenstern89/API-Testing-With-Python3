...
import os
from apidemotest.src.utilities.credentialsUtility import CredentialsUtility
from apidemotest.src.configs.hosts_config import DB_HOST
...
class DBUtility(object):
    ...
    def __init__(self):
        ...
        if self.machine == 'docker' and self.wp_host =='mamp':
            raise Exception (f"Can not run test in docker if WP_HOST=mamp")
