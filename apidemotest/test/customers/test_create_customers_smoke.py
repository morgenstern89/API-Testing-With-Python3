...
from apidemotest.src.helpers.customers_helper import CustomerHelper
from apidemotest.src.dao.customers_dao import CustomersDAO
from apidemotest.src.utilities.requestsUtilities import RequestsUtilities

@pytest.mark.customers
@pytest.mark.tcid29
def test_create_customers_only_email_password():
    ...
    #verify customer is created in databases


@pytest.mark.customers
@pytest.mark.tcid47
def test_create_customers_fail_for_existing_email():
